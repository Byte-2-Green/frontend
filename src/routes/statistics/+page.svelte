<script lang="ts">
  ...
  async function fetchAcceptedChallenges() {
      try {
          ...
          if (!res.ok) {
              throw new Error(`Failed to fetch accepted challenges: ${res.statusText}`);
          }
          return await res.json();
      } catch (error) {
  ...
  async function fetchDeniedChallenges() {
      try {
          ...
          if (!res.ok) {
              throw new Error(`Failed to fetch denied challenges: ${res.statusText}`);
          }
          return await res.json();
      } catch (error) {
  ...
  async function fetchUserAcceptedChallenges(userId: string) { // Add type annotation
      try {
          ...
          if (!res.ok) {
              throw new Error(`Failed to fetch user accepted challenges: ${res.statusText}`);
          }
          return await res.json();
      } catch (error) {
  ...
  async function fetchUserDeniedChallenges(userId: string) { // Add type annotation
      try {
          ...
          if (!res.ok) {
              throw new Error(`Failed to fetch user denied challenges: ${res.statusText}`);
          }
          return await res.json();
      } catch (error) {
